...
Item {
    ...
    property bool isValidAlbumArt: albumArt == "" ? false : true

    readonly property string identity: !root.noPlayer ? (mpris2Source.currentData ? mpris2Source.currentData.Identity : "") || mpris2Source.current : ""
    ...
    Plasmoid.compactRepresentation: MinimalRepresentation {}
