...
MouseArea {
    ...
    PlasmaComponents3.ComboBox {
        ...
        z: 999
        opacity: root.isValidAlbumArt ? 0 : 1
        textRole: "text"
    ...
    FastBlur {
        ...
        transitions: [
            Transition {
                ...
                from: ""; to: "visible"
                SequentialAnimation {
                    PropertyAnimation { property: "radius"; duration: 200 }
                }
            }
        ]
    }
    ...
    Rectangle {
        ...
        states: [
            State {
                ...
                PropertyChanges {
                    target: blackOverlay
                    opacity: root.isValidAlbumArt ? 0.5 : 0
                }
            }
        ]
    ...
    Column {
        ...
        RowLayout {
            ...
            PlasmaComponents3.Label {
                ...
                text: KCoreAddons.Format.formatDuration(expandedRepresentation.length / 1000, expandedRepresentation.durationFormattingOptions)
                opacity: 0.9
                font: theme.smallestFont
            }
        }
    ...
    anchors.fill: parent
    onEntered: {
        controlCol.state = 'visible',
                blurOverlay.state = 'visible',
                blackOverlay.state = 'visible',
                playerCombo.state = 'visible'
    }
    onExited: {
        controlCol.state = '',
                blurOverlay.state = '',
